...
const projects = [
  ...
  },
  {
    ...
    subtitle: "Event-Based Real-Time System",
    github: "https://github.com/VishalPatilDev/Warehouse-Inventory-Tracker",
    stack: ["Java", "Spring Boot", "React.js", "Collections Framework", "Multithreading", "REST APIs"],
    highlights: [
      "Developed a real-time inventory tracking system using Spring Boot and React.js.",
      "Managed concurrent inventory operations using synchronized multithreading for thread-safe stock updates.",
      "Applied Observer Design Pattern to automatically trigger low-stock alerts below threshold.",
